...
public class UserBotManager {
    ...
    private void initConsoleThread(UserBot userBot) {
        executor.submit(() -> {
    ...
    private void writeHistoryToFile(UserBot userBot) {
        ExecutorService writer = Executors.newSingleThreadExecutor();
        writer.execute(userBot::writeHistory);
        writer.shutdown();
    }

    private void loadHistory(UserBot userBot, String folderIDString, String dateFromString, String dateToString) {
